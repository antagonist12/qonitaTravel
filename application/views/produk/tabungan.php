...
<div class="container mt-3">
    ...
    <section class="section-one">
        ...
        <div class="cotainer">
            <div class="isi">
                <div class="row my-3">
                    <?php foreach ($produk as $tabungan) : ?>
                        <div class="col-md-4">
                            <a href="<?= base_url('assets/img/produk/'); ?><?= $tabungan['gambar']; ?>" target="_blank">
                                <img src="<?= base_url('assets/img/produk/'); ?><?= $tabungan['gambar']; ?>" class="img-fluid img-thumbnail">
                            </a>
                            <div class="label mt-3 mb-3 text-center">
                                <h5><?= $tabungan['nama']; ?></h5>
                                <a href="<?= base_url('produk/detailPaketTabungan/') . $tabungan['id_produk']; ?>" class="btn btn-primary button">Detail Tabungan</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
