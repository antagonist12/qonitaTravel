...
<div class="container mt-3">
    ...
    <section class="section-one">
        ...
        <div class="cotainer">
            <div class="isi">
                <div class="row my-3">
                    <?php foreach ($produk as $tour) : ?>
                        <div class="col-md-4">
                            <a href="<?= base_url('assets/img/produk/'); ?><?= $tour['gambar']; ?>" target="_blank">
                                <img src="<?= base_url('assets/img/produk/'); ?><?= $tour['gambar']; ?>" class="img-fluid img-thumbnail">
                            </a>
                            <div class="label mt-3 mb-3 text-center">
                                <h5><?= $tour['nama']; ?></h5>
                                <a href="<?= base_url('produk/detailPaketTour/') . $tour['id_produk']; ?>" class="btn btn-primary button">Detail Paket</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
